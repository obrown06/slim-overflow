defmodule SlimOverflowWeb.AuthTest do
  use SlimOverflowWeb.ConnCase

  alias SlimOverflow.Questions
  alias SlimOverflowWeb.Auth
  alias SlimOverflow.Repo

  setup %{conn: conn} do
    conn =
      conn
      |> bypass_through(SlimOverflowWeb.Router, :browser)
      |> get("/")
  ...
  #  conn =
  #    conn
  #    |> assign(:current_user, %SlimOverflow.Accounts.User{})
  ...
  #  login_conn =
  #    conn
  #    |> Auth.login(%SlimOverflow.Accounts.User{id: 123})
  #    |> send_resp(:ok, "")
