...
defmodule SlimOverflowWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: SlimOverflowWeb.Coherence.EmailView, layout: {SlimOverflowWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
