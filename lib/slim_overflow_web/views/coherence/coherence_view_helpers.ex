defmodule SlimOverflowWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers SlimOverflowWeb.Router.Helpers
  use CoherenceAssent.ViewHelpers, helpers: SlimOverflowWeb.Router.Helpers
